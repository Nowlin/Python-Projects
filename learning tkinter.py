...
class ParentWindow(Frame):
    def __init__ (self, master):
        ...
        self.txtFName = Entry(self.master, text=self.varLName, font =("Helvetica", 16), fg='black', bg='lightblue')
        ...
        self.btnCancel = Button(self.master, text="Submit", width=10, height=2m command=self.cancel)
